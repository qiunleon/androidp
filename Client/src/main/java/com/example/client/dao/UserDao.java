...
import com.example.client.greendao.Pig;
...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Index = new Property(3, long.class, "index", false, "INDEX");
        public final static Property PigId = new Property(4, Long.class, "pigId", false, "PIG_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"AWESOME_USERS\" (" + //
                ...
                "\"PIG_ID\" INTEGER," + // 4: pigId
                "\"ALIAS\" TEXT NOT NULL );"); // 5: alias
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "indexAlias ON \"AWESOME_USERS\"" +
                " (\"INDEX\" ASC);");
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        Long pigId = entity.getPigId();
        if (pigId != null) {
            stmt.bindLong(5, pigId);
        }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getLong(offset + 3), // index
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4), // pigId
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setIndex(cursor.getLong(offset + 3));
        entity.setPigId(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getPigDao().getAllColumns());
            builder.append(" FROM AWESOME_USERS T");
            builder.append(" LEFT JOIN PIG T0 ON T.\"PIG_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected User loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Pig pig = loadCurrentOther(daoSession.getPigDao(), cursor, offset);
        entity.setPig(pig);
