    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
                View view = LayoutInflater.from(
                        LinearScrollActivity.this).inflate(R.layout.line_image_item2, parent,
                        false);
                MyViewHolder holder = new MyViewHolder(view);

            WindowManager wm = (WindowManager) LinearScrollActivity.this
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            Picasso.with(LinearScrollActivity.this).load(Images.get(position).getUrl()).into(holder.iv);
