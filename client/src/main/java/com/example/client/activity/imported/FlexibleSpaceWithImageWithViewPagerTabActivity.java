...
import com.example.client.fragment.imported.FlexibleSpaceWithImageScrollFragment;
import com.example.client.fragment.imported.FlexibleSpaceWithImageGridViewFragment;
import com.example.client.fragment.imported.FlexibleSpaceWithImageListViewFragment;
import com.example.client.fragment.imported.FlexibleSpaceWithImageRecyclerViewFragment;
import com.example.client.fragment.imported.FlexibleSpaceWithImageScrollViewFragment;
import com.github.ksoichiro.android.observablescrollview.CacheFragmentStatePagerAdapter;
import com.github.ksoichiro.android.observablescrollview.ScrollUtils;
import com.github.ksoichiro.android.observablescrollview.Scrollable;
import com.example.client.ui.widget.SlidingTabLayout;
...
public class FlexibleSpaceWithImageWithViewPagerTabActivity extends BaseActivity {
    ...
    public void onScrollChanged(int scrollY, Scrollable s) {
        FlexibleSpaceWithImageScrollFragment fragment =
                (FlexibleSpaceWithImageScrollFragment) mPagerAdapter.getItemAt(mPager.getCurrentItem());
        if (fragment == null) {
            return;
        }
    ...
    private void propagateScroll(int scrollY) {
        ...
        for (int i = 0; i < mPagerAdapter.getCount(); i++) {
            ...
            FlexibleSpaceWithImageScrollFragment f =
                    (FlexibleSpaceWithImageScrollFragment) mPagerAdapter.getItemAt(i);
            if (f == null) {
                continue;
            }
